...
class LessonCRUDTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.moderator = User.objects.create(
            email="moderator@test.com", password="modpass"
        )
        ...
        self.detail_url = reverse(
            "materials:lessons_retrieve", kwargs={"pk": self.lesson.pk}
        )
        self.update_url = reverse(
            "materials:lessons_update", kwargs={"pk": self.lesson.pk}
        )
        self.delete_url = reverse(
            "materials:lessons_delete", kwargs={"pk": self.lesson.pk}
        )
...
class SubscriptionTestCase(APITestCase):
    ...
    def setUp(self):
        # Создаем пользователей
        self.user1 = User.objects.create(email="user1@test.com", password="testpass1")
        self.user2 = User.objects.create(email="user2@test.com", password="testpass2")
